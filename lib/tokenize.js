 ...
 *
 * Authored as a UMD module so the same file works in Node (`require`) and in
 * the browser (`<script src>` exposes `window.NLP.tokenize`).
 *
...
(function (root, factory) {
  if (typeof module === 'object' && module.exports) {
    ...
    root.NLP = root.NLP || {};
    root.NLP.tokenize = factory().tokenize;
  }
